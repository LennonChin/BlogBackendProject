...
class NavigationLink(models.Model):
    ...
    en_name = models.CharField(max_length=30, verbose_name="英文名称", help_text="英文名称")
    desc = models.CharField(max_length=100, verbose_name="简介", help_text="简介")
    en_desc = models.CharField(max_length=100, verbose_name="英文简介", help_text="英文简介")
...
class SiteInfo(models.Model):
    ...
    en_name = models.CharField(default="", max_length=20, verbose_name="名称英文", help_text="名称英文")
    desc = models.CharField(default="", max_length=150, verbose_name="简介", help_text="简介")
    en_desc = models.CharField(default="", max_length=150, verbose_name="简介", help_text="简介")
