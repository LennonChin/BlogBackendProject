...
class AlbumInfo(models.Model):
    ...
    tags = models.ManyToManyField(MaterialTag, through="AlbumTag", verbose_name="标签", help_text="标签")
    pictures = models.ManyToManyField(MaterialPicture, through="AlbumPhoto", verbose_name="图片", help_text="图片")
