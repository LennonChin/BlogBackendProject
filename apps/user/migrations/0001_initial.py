    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('send_type', models.CharField(choices=[('register', '注册'), ('forget', '找回密码'), ('update_email', '修改邮箱')], help_text='验证码类型', max_length=15, verbose_name='验证码类型')),
                ('send_time', models.DateTimeField(default=datetime.datetime.now, help_text='发送时间', verbose_name='发送时间')),
            ],
            options={
                'verbose_name': '邮箱验证码',
