    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detail', models.ForeignKey(help_text='内容', on_delete=django.db.models.deletion.CASCADE, to='article.ArticleDetail', verbose_name='内容')),
            ],
            options={
                'verbose_name': '文章基本信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, help_text='添加时间', verbose_name='添加时间')),
                ('article', models.ForeignKey(help_text='文章', on_delete=django.db.models.deletion.CASCADE, to='article.ArticleInfo', verbose_name='文章')),
        ...
        migrations.AddField(
            ...
            name='tags',
            field=models.ManyToManyField(through='article.ArticleTag', to='material.MaterialTag'),
        ),
    ]
